...
_include_router("app.api.v1.pipelines", prefix="/api/v1")
_include_router("app.api.v1.analysis_endpoints", prefix="/api/v1")
_include_router("app.api.v1.dashboard_endpoints", prefix="/api/v1")
_include_router("app.api.v1.chat", prefix="/api/v1")
_include_router("app.api.v1.chat_v2", prefix="/api/v1")
_include_router("app.api.v1.analytics_endpoints_new", prefix="/api/v1")
_include_router("app.api.v1.import_routes", prefix="/api/v1")
